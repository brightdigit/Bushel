...
public struct ImageMetadata : Codable, CustomDebugStringConvertible, Hashable {
  public init(isImageSupported: Bool, buildVersion: String, operatingSystemVersion: OperatingSystemVersion, sha256: SHA256, contentLength: Int, lastModified: Date, url: URL) {
