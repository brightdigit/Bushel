...
struct RestoreImageItemView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        List{
            RestoreImageItemView(image: Self.remotePreviewItem).listRowSeparator(.visible, edges: .bottom)
            
            RestoreImageItemView(image: Self.localPreviewItem).listRowSeparator(.visible, edges: .bottom)
            
            
            RestoreImageItemView(image: Self.unsupportedPreviewItem).listRowSeparator(.visible, edges: .bottom)
            
            RestoreImageItemView(image: Self.outlierPreviewItem).listRowSeparator(.visible, edges: .bottom)
